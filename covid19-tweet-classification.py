# -*- coding: utf-8 -*-
"""
Created on Sun Jul 31 12:26:10 2022
...
df_train = pd.read_csv('E:/NLP/Covid19-Tweet-Classification-main/train.csv',encoding='latin-1')
df_test = pd.read_csv('E:/NLP/Covid19-Tweet-Classification-main/test.csv',encoding='latin-1')
df_train.head()
